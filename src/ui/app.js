...
function panelAppearance() {
  ...
  shot.innerHTML = portraitSvg(c, { variant: 'sheet' });
  body.appendChild(shot);
...
function renderBattle() {
  ...
  if (foeFace) {
    ...
    foeFace.innerHTML = foeNpc
      ? npcPortrait(foeNpc, { maturityRate: getRace(foeNpc.raceId).maturityRate ?? 1, form: foeForm, mode: 'battle', variant: 'sprite' })
      : '';
  ...
  if (meFace) {
    ...
    meFace.innerHTML = portraitSvg(GAME.character, { form: myForm, mode: 'battle', variant: 'sprite' });
  }
